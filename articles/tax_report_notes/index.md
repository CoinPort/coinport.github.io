...
1. are an Individual;
1. are an Australian resident for Australian tax purposes; and
1. have been undertaking digital asset activities on CoinPort as an Investor only, and is based on the details you entered when creating your CoinPort account.

If you are not an Australian resident for tax purposes, you may be a temporary resident or foreign resident and should seek professional advice regarding your liability to pay tax and comply with tax obligations in Australia with respect to your digital asset dealings through CoinPort.
...
Where an individual undertakes digital asset activities on other digital asset exchanges and/or blockchain networks, this Report is provided to assist customers of CoinPort in complying with their Australian tax reporting and record-keeping obligations but will not reflect all activity that would be reflected if the individual solely used CoinPort to undertake its digital asset activities

This Report is a guide only and is not a complete statement of the relevant tax law, nor does it take account of your individual circumstances (particularly digital asset activities you may have undertaken on other Virtual Asset Service Providers and/or directly via blockchain networks). Nothing in this Report should be considered as legal, accounting or tax advice. Accordingly, we recommend that you seek independent, professional tax advice about the tax implications of your digital asset activities in your specific circumstances.
...
Other than where you have been prompted to enter information on the CoinPort website, this Report does not consider the impact of your non-CoinPort digital asset activities, nor does it calculate the tax implications for digital asset activities you undertake on other Virtual Asset Service Providers and/or blockchain networks.

Your self-assessed tax characterisation as an Investor may not be accurate if you have undertaken digital asset activities on other Virtual Asset Service Providers and/or directly via blockchain networks. You are responsible for verifying the accuracy of your tax characterisation as an Investor, as well as keeping appropriate records to accurately determine your Australian tax position and comply with your tax obligations each income year. Accordingly, we recommend that you provide this Report to your registered tax agent who can advise you as to the appropriate use of the information contained in this Report in preparing your Individual Tax Return and meeting your tax obligations.
...
Tax assumptions regarding CoinPort transactions

A number of assumptions have been made regarding how each type of CoinPort transaction is treated for Australian tax purposes in generating this Report. Where possible, the assumptions are based on applicable case law principles and published web guidance by the ATO, which may be subject to change with either retrospective or prospective impact. In some case, no guidance is available, and a pragmatic view has been taken

The assumptions are as follows:

## Deposit of Australian dollars

The deposit of Australian dollars in your CoinPort account is not treated as a taxing event. As such, no CGT cost base is set in relation to the deposit of Australian dollars in your CoinPort account.

## Deposit of a digital asset (Transfers In)

By default, CoinPort sets the CGT cost base of a digital asset transferred into your CoinPort wallet at the market rate (as per CoinPort exchange rates) at the time of receipt by CoinPort and the date of acquisition of a digital asset as the date of receipt by CoinPort. Your actual CGT cost base and original date of acquisition will most likely be different.
...
CoinPort Maker and Taker fees charged on acquisition will be added to the CGT cost base of your digital asset.
...
The Australian dollar value of the first digital asset at the time of the transaction is treated as the amount of capital proceeds received when working out whether you have made a capital gain or capital loss. All digital assets listed on CoinPort are supported by an Australian dollar trading pair. As such, the CoinPort Australian dollar trading pair exchange rate for the first digital asset will be automatically applied to calculate the capital proceeds received on disposal of the first digital asset.

The Australian dollar value of CoinPort Maker and Taker fees charged on disposal will be added to the CGT cost base of your digital asset. Maker and Taker fees for digital asset to digital asset transactions are charged in the first digital asset. As such, the CoinPort Australian dollar trading pair exchange rate for the first digital asset will be automatically applied to calculate the Australian dollar value of fees charged.
...
CoinPort Maker and Taker fees charged on disposal will be added to the CGT cost base of your digital asset. Maker and Taker fees are charged in the digital asset that is being disposed of. As such, the CoinPort Australian dollar trading pair exchange rate for the digital asset will be automatically applied to calculate the Australian dollar value of fees charged.
...
The withdrawal of Australian dollars from your CoinPort account is not treated as a taxing event and no CGT consequences should arise in relation to the withdrawal of Australian dollars from your CoinPort account.

## Withdrawal of a digital asset (Transfers Out)

The withdrawal of a digital asset from your CoinPort wallet to an external wallet is not treated as a taxing event.

CoinPort assumes that you are not registered for GST or required to be registered for GST. As such, the GST inclusive amount of CoinPort Maker and Taker fees is included in the CGT cost base of your digital asset.

CoinPort assumes that all digital assets listed on CoinPort meet the definition of 'digital currency' for GST purposes, or otherwise should be treated as GST-free financial supplies. As such, the disposal of digital assets on CoinPort should be treated as equivalent to money and should not give rise to GST consequences with respect to the digital asset supplied (noting that GST is applicable to the CoinPort Maker and Taker fees). The GST definition of 'digital currency' is relatively new and subject to some uncertainty. To the extent that the ATO considers that GST applies to the underlying supply of a digital asset disposed of on CoinPort, then you are liable to pay any amount of GST (and applicable interest and penalties) applicable to the ATO. CoinPort will not be responsible for GST for which you may be liable to collect and remit to the ATO. Accordingly, we recommend that you seek independent, professional tax advice specific to your circumstances.
...
This Report adopts a tax treatment of Hard Forks that aligns with the current ATO web guidance, such that no gain will be calculated on the deposit of the new digital asset into your CoinPort wallet and a CGT cost base of zero will be recorded for the new digital asset. The date of acquisition of the new digital asset will be treated as the date the new digital asset is deposited into your CoinPort wallet.

Where you hold a digital asset in your CoinPort wallet just before the Hard Fork, you will receive the new digital asset into a CoinPort wallet that you control if, after CoinPort has reviewed the new digital asset, CoinPort decides to list and support trading of the new digital asset on CoinPort.
...
This Report adopts a tax treatment of airdrops that aligns with the current ATO web guidance outlined above, such that airdrops will only be permitted for cryptocurrencies that are already listed on CoinPort and CoinPort will record the market value of the digital asset at the time it is received into your CoinPort wallet. However, not all airdrops are the same and you are responsible for seeking independent, professional advice about your circumstances.

## No Responsibility

CoinPort does not warrant or otherwise guarantee the accuracy or completeness of assumptions made regarding how each type of CoinPort transaction is treated for Australian tax purposes or the accuracy or completeness of amounts produced in this Report and do not accept liability for any loss arising from using this Report. Accordingly, we recommend that you seek independent professional advice regarding your use of this Report.

CoinPort do not accept any responsibility for verifying the accuracy of information about digital asset activities you have undertaken on other Virtual Asset Service Providers and/or blockchain networks that you choose to enter into outside of CoinPort.

Whilst every effort has been made to ensure the assumptions and calculations underlying this Report are correct, CoinPort accepts no liability for errors or omissions in assumptions or calculated figures. We reserve the right to remedy any errors or omissions that may be present in this Report. If you find an error or omission in this Report, please advise us immediately.
