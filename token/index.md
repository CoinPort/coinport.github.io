...
**Contract:** [`0x37dAa811B668bf5d19692A7F79579B7BFaaB26A5`](https://etherscan.io/token/0x37dAa811B668bf5d19692A7F79579B7BFaaB26A5)
...
All minted CPP is sent to the CoinPort hot wallet at `0xfcE919e9A781b66b3Cf91A9F021aE2eF104D9256`. Per-member balances are not minted directly to per-member on-chain addresses; they are tracked in the CoinPort member ledger. This is the on-chain expression of Model B custody (§4.1).
...
| | |
|---|---|
| Token contract (proxy) | [`0x37dAa811B668bf5d19692A7F79579B7BFaaB26A5`](https://etherscan.io/token/0x37dAa811B668bf5d19692A7F79579B7BFaaB26A5) |
| Hot wallet (`MINTER_ROLE`) | `0xfcE919e9A781b66b3Cf91A9F021aE2eF104D9256` |
| Network | Ethereum mainnet (chain id 1) |
